...
namespace ZestyBiteSolution.Areas.Procurement_Manager.Controllers {
    ...
    public class HomeController : Controller {
        ...
        public class SupplyController : ControllerBase
        {
            ...
            // PUT: api/Supply/{id}
            [HttpPut("update/{tableId:int}")]
            public async Task<IActionResult> UpdateSupply(int tableId, [FromBody] SupplyDTO dto)
            {
                if (dto == null)
                {
                ...
                try
                {
                    ...
                    var updatedSupply = await _supplyService.UpdateSupplyAsync(dto, tableId);
