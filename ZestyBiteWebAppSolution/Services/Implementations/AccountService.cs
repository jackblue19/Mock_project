...
namespace ZestyBiteWebAppSolution.Services.Implementations {
    public class AccountService : IAccountService {
        ...
        public AccountService(IAccountRepository accountRepository, IRoleRepository roleRepository, ZestybiteContext context, IEmailConfirmationRepository emailConfirmationRepository) {
        ...
        public async Task ConfirmEmailAsync(string email) {
            ...
            account.IsEmailConfirmed = true; // Đánh dấu tài khoản đã xác nhận
            _context.Accounts.Update(account);
            await _context.SaveChangesAsync();
        }

        public async Task SaveConfirmationTokenAsync(string email, string token) {
            await _emailConfirmationRepository.SaveConfirmationTokenAsync(email, token);
        }
